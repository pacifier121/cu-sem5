...
<!-- cert -->
        <ul class="nav navbar-nav navbar-right">
            ...
            <ul class="dropdown-menu">
                <li><a href="cart.php" class="bg-secondary" style="text-decoration:none; color:blue;">Cart</a></li>
                <li class="divider"></li>
                <li><a href="#" class="bg-secondary" style="text-decoration:none; color:blue;">Change password</a></li>
                <li class="divider"></li>
                <li><a href="logout.php" class="bg-secondary" style="text-decoration:none; color:blue;">Logout</a></li>
            </ul>
            </li>
